...
| Module and plugin safety rules | [ADR-0008](decisions/0008-extension-authority-and-lifecycle-corrections.md), which supersedes [ADR-0007](decisions/0007-extension-module-safety-boundary-clarifications.md) and [ADR-0006](decisions/0006-extension-module-safety-boundaries.md) |
