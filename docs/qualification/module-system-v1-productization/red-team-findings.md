...
| Security | JSON execution/publisher claims could describe their own trust | Custody V2 is negative-only; no executable or publisher claim can authorize promotion without a separate authenticated receipt |
