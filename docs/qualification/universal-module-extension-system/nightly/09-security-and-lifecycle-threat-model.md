...
| Manual digest mistaken for current release | Authentic old bytes bypass freshness, revocation or publisher-currentness expectations | No remote artifact route | Label direct digest `manual-pin/no-currentness`; require TUF before remote mutable channels or currentness claims |
