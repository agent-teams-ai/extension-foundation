...
| Disposable binding compiler | Explicit required, optional and ordered-many bindings; structural collision-free coordinates; fail-closed cardinality/version checks; duplicate declarations/providers/offers, including unbound offers; missing providers and binding-induced cycles | Production grammar, compatibility policy, product ownership, package or public SPI |
...
- one durable intent fixing three non-renewable absolute horizons and producing
  authority-clock effect/publication receipts, host-monotonic termination and
